...
class QuotationServiceTest {
    ...
    @Nested
    @DisplayName("sendQuotationToCustomer")
    class SendQuotationToCustomerTests {

        private Quotation buildQuotationWithStatus(Long id, String status) {
        ...
        @Test
        @DisplayName("UTC01 - Normal: existing DRAFT quotation -> SENT & notifications/email sent")
        void sendQuotationToCustomer_UTC01_validDraft() {
            Long id = 1L;
            Quotation quotation = buildQuotationWithStatus(id, "DRAFT");
            ...
            Quotation result = quotationService.sendQuotationToCustomer(id);
            ...
            verify(notificationService).notifyQuotationSentToCustomer(quotation);
            verify(emailService).sendQuotationEmail(quotation);

            verifyNoMoreInteractions(quotationRepository, notificationService, emailService);
        }

        @Test
        @DisplayName("UTC02 - Abnormal: quotation not found")
        void sendQuotationToCustomer_UTC02_quotationNotFound() {
            Long id = 999L;
            when(quotationRepository.findById(id)).thenReturn(Optional.empty());

            assertThrows(NoSuchElementException.class,
                    () -> quotationService.sendQuotationToCustomer(id));
        ...
        @Test
        @DisplayName("UTC03 - Abnormal: status SENT")
        void sendQuotationToCustomer_UTC03_statusSent() {
            Long id = 1L;
            Quotation quotation = buildQuotationWithStatus(id, "SENT");
            when(quotationRepository.findById(id)).thenReturn(Optional.of(quotation));
        ...
        @Test
        @DisplayName("UTC04 - Abnormal: status ACCEPTED")
        void sendQuotationToCustomer_UTC04_statusAccepted() {
            Long id = 1L;
            Quotation quotation = buildQuotationWithStatus(id, "ACCEPTED");
            when(quotationRepository.findById(id)).thenReturn(Optional.of(quotation));
        ...
        @Test
        @DisplayName("UTC05 - Abnormal: status REJECTED")
        void sendQuotationToCustomer_UTC05_statusRejected() {
            Long id = 1L;
            Quotation quotation = buildQuotationWithStatus(id, "REJECTED");
            when(quotationRepository.findById(id)).thenReturn(Optional.of(quotation));
        ...
        @Test
        @DisplayName("UTC06 - Abnormal: status ORDER_CREATED")
        void sendQuotationToCustomer_UTC06_statusOrderCreated() {
            Long id = 1L;
            Quotation quotation = buildQuotationWithStatus(id, "ORDER_CREATED");
            when(quotationRepository.findById(id)).thenReturn(Optional.of(quotation));
        ...
        @Test
        @DisplayName("UTC07 - Abnormal: status null")
        void sendQuotationToCustomer_UTC07_statusNull() {
            Long id = 1L;
            Quotation quotation = buildQuotationWithStatus(id, null);
            when(quotationRepository.findById(id)).thenReturn(Optional.of(quotation));
