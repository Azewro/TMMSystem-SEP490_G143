...
@Schema(name = "RfqAssignRequest", description = "Request gán Sales và Planning cho RFQ ở trạng thái DRAFT")
public class RfqAssignRequest {
    ...
    @NotNull
    @Schema(description = "ID Planning phụ trách kiểm tra năng lực", example = "8", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    public Long getAssignedPlanningId() { return assignedPlanningId; }
    public void setAssignedPlanningId(Long assignedPlanningId) { this.assignedPlanningId = assignedPlanningId; }
