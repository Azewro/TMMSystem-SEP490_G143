...
public class ExecutionController {
    ...
    public ExecutionController(ExecutionOrchestrationService service){ this.service = service; }
    ...
    public ProductionStage updateProgress(@PathVariable Long stageId, @RequestParam Long userId, @RequestParam Integer percent){
    ...
    public QcSession submitQc(@PathVariable Long sessionId, @RequestParam String result, @RequestParam(required=false) String notes, @RequestParam Long qcUserId){
        return service.submitQcSession(sessionId, result, notes, qcUserId);
    }
    ...
    public tmmsystem.entity.MaterialRequisition createMaterialRequest(@PathVariable Long issueId, @RequestParam Long techUserId, @RequestParam(required=false) String notes){
        return service.createMaterialRequest(issueId, techUserId, notes);
    }

    @PostMapping("/material-requisitions/{reqId}/approve")
    public tmmsystem.entity.MaterialRequisition approveMaterialRequest(@PathVariable Long reqId, @RequestParam Long pmUserId){
